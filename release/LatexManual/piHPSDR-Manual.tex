...
\rett{NR2 Post-Processing}. \textbf{New in WDSP 1.27!}
...
$\bullet$ RX1 audio output device (only RX1, not RX2!)\cr
...
\subsection[PipeWire: NullSink modules]{PulseAudio: Null-Sink modules as virtual audio cables}
