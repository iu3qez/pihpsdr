...
repeat the command \grtt{SoapySDRUtil -info}, and in the output you should no see an additional
line stating the new module, in my case this line read
...
to compose an automatic install script for the required SoapySDR modules.
