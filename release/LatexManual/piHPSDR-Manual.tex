...
gain, the VOX threshold and the CW speed (see Sec. \ref{sec:SlidersMenu}).
...
The functions you can assign are (in the order they appear in the combo-boxes). Since the space
...
\item[\rett{LineinGain}]{(Line) The gain of the Line-In jack of the radio (if available).}
